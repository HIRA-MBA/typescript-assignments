...
let book: {author:string; title:string; yearPublish:number}={author:"Jane Austen",
...
let fav_car:{manufacturer:string; make:string ; model:number}={manufacturer:"HONDA", make:"city ", model:2022}
