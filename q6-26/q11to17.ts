...
let Names :string[] =["mary","james","peter"]
console.log("\n \t Assignment 11 \n")
console.log(Names[0])
console.log(Names[1])
console.log(Names[2])
...
let cars : string[] = ["honda","suzuli","toyota"]
console.log("\n \t Assignment 13 \n")
...
let guests :string[] = ["sara","fara","maria"]
console.log("\n \t Assignment 14 \n")
...
let guests_new :string[] = ["sara","fara","maria"]
console.log("\n \t Assignment 15 \n")
...
let new_guests: string[] = ["peter","perker","robbert","sara","Mary","fara"]
