...
let new_magicians : string[] = ["peter","parker","harry","potter"]
function show_magicians1(new_magicians:string[]) {
    new_magicians.forEach((new_magician) => {console.log(new_magician)
...
function make_great(new_magicians:string[]){
